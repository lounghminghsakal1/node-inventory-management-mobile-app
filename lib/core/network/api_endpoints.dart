...
class ApiEndpoints {
  ...
  static const String nodeStats = '/node_stats';
  ...
  static String shipmentAutoAllocate(String id) =>
      '/shipments/$id/auto-allocate';
  ...
  static String shipmentMarkDispatched(String id) =>
      '/shipments/$id/mark_dispatched';
  static String shipmentDeliver(String id) => '/shipments/$id/deliver';
  static String shipmentReturnInitiate(String id) =>
      '/shipments/$id/return/initiate';
  static String returnRemaining(String id) => '/shipments/$id/return_remaining';
  static String assignReturnItems(String id) =>
      '/shipments/$id/assign_return_items';
  ...
  static String returnAllocationInfo(String id) =>
      '/shipments/$id/return_remaining';
  ...
  static String verifySerialAvailability(
    String shipmentId,
    String skuId,
    String serialNumber,
  ) =>
      '/shipments/$shipmentId/serial_availability?sku_id=$skuId&serial_number=$serialNumber';
  ...
  static String batchInventoryTransactions(String id) =>
      '/batch_inventories/$id/transactions';
  ...
  static String nodeInventoryTransactions(String id) =>
      '/node_inventories/$id/transactions';
  ...
  static const String uploadGrnDocument =
      '/goods_received_notes/upload_document';
  ...
  static String uploadGrnLineItemsPhotos(String grnId) => '/goods_received_notes/$grnId/upload_line_item_photos';
  ...
  static String stockAuditLineItems(String id) =>
      '/stock_audits/$id/line_items';
  static String stockAuditSkuBatches(String auditId, String skuId) =>
      '/stock_audits/$auditId/skus/$skuId/sku_batches';
  static String stockAuditSkuSerials(String auditId, String skuId) =>
      '/stock_audits/$auditId/skus/$skuId/sku_serials';
  static String stockAuditCountSku(String auditId, String skuId) =>
      '/stock_audits/$auditId/skus/$skuId/count_sku';
  static String sendStockAuditForReview(String id) =>
      '/stock_audits/$id/send_for_review';
