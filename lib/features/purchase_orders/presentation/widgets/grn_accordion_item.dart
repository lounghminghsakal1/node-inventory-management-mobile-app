...
class _GrnAccordionItemState extends ConsumerState<GrnAccordionItem> {
  ...
  void didUpdateWidget(covariant GrnAccordionItem oldWidget) {
    ...
    if (oldWidget.grn.id != widget.grn.id ||
        oldWidget.grn.status != widget.grn.status) {
  ...
  Widget _buildExpandedBody(GrnModel grn) {
    ...
    if (statusLower == 'created') {
      return _buildCreatedStatusView(grn);
        ...
        statusLower == 'waiting_for_approval') {
  ...
  Widget _buildCreatedStatusView(GrnModel grn) {
    ...
    final splash = ref.watch(splashDataProvider).valueOrNull;
    final canUpdateGrn =
        splash?.hasPermission('GoodsReceivedNote', 'update') ?? false;
    ...
    return Column(
      ...
      children: [
              ...
              children: [
                Builder(
                  builder: (context) {
                    ...
                    final shouldHideInputBlockByDefault =
                        widget.grn.status.toLowerCase() == 'created' &&
                    ...
                    return Column(
                      ...
                      children: [
                        if (!canUpdateGrn)
                            ...
                            Builder(
                              builder: (context) {
                                ...
                                final currentlySelectedIds = _inwardBlocks
                                    .where(
                                      (id) => id != null && id != selectedSkuId,
                                    )
                                    .toSet();
                                final availableSkusForBlock = unfulfilledSkus
                                    .where(
                                      (sku) => !currentlySelectedIds.contains(
                                        sku.productSkuId,
                                      ),
                                    )
                                    .toList();
                                ...
                                final controller = poLi == null
                                    ? null
                                    : _skuQtyControllers.putIfAbsent(
                                        poLi.productSkuId,
                                        () => TextEditingController(),
                                      );
                                final batches = poLi == null
                                    ? <GrnBatchModel>[]
                                    : _skuBatches.putIfAbsent(
                                        poLi.productSkuId,
                                        () => [],
                                      );
                                final serials = poLi == null
                                    ? <String>[]
                                    : _skuSerials.putIfAbsent(
                                        poLi.productSkuId,
                                        () => [],
                                      );
                                        ...
                                        children: [
                                          Expanded(
                                            child: DropdownButtonFormField<int>(
                                              ...
                                              items: availableSkusForBlock.map((
                                                sku,
                                              ) {
                                      ...
                                      if (poLi != null &&
                                        ...
                                        Builder(
                                          builder: (context) {
                                            ...
                                            final isQtyExceeded =
                                                enteredQty >
                                                poLi.remainingQuantity;
                                            final isBatchesAdded =
                                                batches.isNotEmpty &&
                                                batches.fold<int>(
                                                      0,
                                                      (s, b) => s + b.quantity,
                                                    ...
                                                    enteredQty &&
                                                enteredQty > 0;
                                            final isSerialsAdded =
                                                serials.isNotEmpty &&
                                                serials.length == enteredQty &&
                                                enteredQty > 0;
                                                ...
                                                LayoutBuilder(
                                                  builder: (context, constraints) {
                                                    ...
                                                    final textFieldWidget = AppTextField(
                                                      label:
                                                          "Received Qty * (Max: ${poLi.remainingQuantity})",
                                                      ...
                                                      onChanged: (val) {
                                                        final newQty =
                                                            int.tryParse(val) ??
                                                            0;
                                                        if (poLi.trackingType ==
                                                            'batch') {
                                                          final currentBatchSum =
                                                              batches.fold<int>(
                                                                0,
                                                                (s, b) =>
                                                                    s +
                                                          ...
                                                          if (poLi.trackingType ==
                                                              ...
                                                              child: ElevatedButton.icon(
                                                                style: ElevatedButton.styleFrom(
                                                                  backgroundColor:
                                                                      ...
                                                                      ? AppColors
                                                                            .success
                                                                      : AppColors.getTrackingTextColor(
                                                                          'batch',
                                                                        ),
                                                                  foregroundColor:
                                                                      Colors
                                                                ...
                                                                label: Text(
                                                                  isBatchesAdded
                                                                      ? "Batches Added (${batches.length})"
                                                                      : "Add Batches (${batches.length})",
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                                ),
                                                                onPressed: () =>
                                                                    _openBatchModalForSku(
                                                                      poLi,
                                                                    ),
                                                              ),
                                                            )
                                                            ...
                                                            Expanded(
                                                              child: ElevatedButton.icon(
                                                                ...
                                                                label: Text(
                                                                  isSerialsAdded
                                                                      ? "Serials Added (${serials.length})"
                                                                      : "Add Serials (${serials.length})",
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                                ),
                                                                onPressed: () =>
                                                                    _openSerialModalForSku(
                                                                      poLi,
                                                                    ),
                                                              ),
                                                            )
                          ...
                          if (unfulfilledSkus.length >
                              _inwardBlocks.length) ...[
                            const SizedBox(height: 4),
                            SizedBox(
                              width: double.infinity,
                              child: AppButton(
                          ...
                          Builder(
                            builder: (context) {
                              final hasExceededQty = unfulfilledSkus.any((
                                poLi,
                              ) {
                                if (!_inwardBlocks.contains(poLi.productSkuId))
                                  return false;
                                final q =
                                    int.tryParse(
                                      _skuQtyControllers[poLi.productSkuId]
                                              ?.text ??
                                          '0',
                                    ) ??
                                    0;
                              ...
                              final hasAnySelection = _inwardBlocks.any(
                                (id) => id != null,
                              );
                              return SizedBox(
                                width: double.infinity,
        ...
        Text(
          "Inwarded Items (${grn.lineItems.length})",
        ...
        if (grn.lineItems.isEmpty)
          Center(
            child: Padding(
              ...
              child: Text(
                "No items inwarded yet. Add items above.",
                    ...
                    Wrap(
                      ...
                      children: [
                        if (li.trackingType == 'batch' ||
                            li.trackingType == 'serial')
                          InkWell(
                            onTap: () => _showInwardedItemDetailsModal(
                              li,
                              isEditing: false,
                            ),
                            borderRadius: BorderRadius.circular(8),
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: AppColors.getTrackingBgColor(
                                  li.trackingType,
                                ),
                                borderRadius: BorderRadius.circular(8),
                                border: Border.all(
                                  color: AppColors.getTrackingTextColor(
                                    li.trackingType,
        ...
        if (canUpdateGrn)
          SizedBox(
            ...
            child: AppButton(
              ...
              onPressed: (grn.lineItems.isEmpty || _loadingAction != null)
                  ? null
                  : _proceedToQc,
            ),
          ),
  ...
  void _openBatchModalForSku(PoSkuItemModel poLi) {
    final controller = _skuQtyControllers.putIfAbsent(
      poLi.productSkuId,
      () => TextEditingController(),
    );
    ...
    if (qtyVal <= 0 || qtyVal > poLi.remainingQuantity) {
      showTopErrorSnackBar(
        context,
        "Please enter Received Qty between 1 and ${poLi.remainingQuantity} first",
      );
      return;
    }
  ...
  Future<void> _addItemsToGrn(List<PoSkuItemModel> allSkuItems) async {
    ...
    for (final poLi in allSkuItems) {
      ...
      if (qtyVal > poLi.remainingQuantity) {
        showTopErrorSnackBar(
          context,
          "Received Qty for ${poLi.skuName} cannot exceed ${poLi.remainingQuantity}",
        );
        return;
      }
      ...
      if (poLi.trackingType == 'batch') {
        final totalBatchQty = batches.fold<int>(
          0,
        ...
        if (totalBatchQty != qtyVal) {
          showTopErrorSnackBar(
            context,
            "Total batch quantity ($totalBatchQty) does not match received qty ($qtyVal)",
          );
          return;
        }
        if (batches.any((b) => b.batchCode.trim().isEmpty)) {
          showTopErrorSnackBar(
            context,
            "All batches for '${poLi.skuName}' must have a valid Batch Code",
          );
          return;
        }
        ...
        if (serials.length != qtyVal) {
          showTopErrorSnackBar(
            context,
            "Total serials count (${serials.length}) does not match received qty ($qtyVal)",
          );
          return;
        }
      }
    ...
    if (payloadItems.isEmpty) {
      showTopErrorSnackBar(
        context,
        "Please enter Received Qty > 0 for at least one item",
      );
      return;
    }
  ...
  void _showInwardedItemDetailsModal(
    GrnLineItemModel li, {
  ...
  Future<void> _handleInwardedItemUpdate(GrnLineItemModel updatedLi) async {
    ...
    final updatedList = currentLineItems.map((item) {
      if (item.productSkuId == updatedLi.productSkuId ||
          item.id == updatedLi.id) {
        return updatedLi;
      }
      return item;
    }).toList();
  ...
  Future<void> _confirmRemoveInwardedItem(GrnLineItemModel li) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          "Are you sure you want to remove '${li.skuName}' from this GRN? Its received quantity will return to the available PO balance.",
        ),
        actions: [
          TextButton(
  ...
  Future<void> _handleInwardedItemDelete(GrnLineItemModel liToDelete) async {
    ...
    final currentLineItems =
        ref.read(grnDetailProvider(widget.grn.id)).value?.lineItems ??
        widget.grn.lineItems;
    final updatedList = currentLineItems
        .where(
          (item) =>
              item.productSkuId != liToDelete.productSkuId &&
              item.id != liToDelete.id,
        )
        .toList();
  ...
  Future<void> _proceedToQc() async {
    ...
    try {
      ...
      showTopSuccessSnackBar(
        context,
        "GRN transitioned to QC Pending! Details refreshed.",
      );
    } catch (e) {
      if (!mounted) return;
      String errMsg = e.toString().replaceAll('Exception: ', '');
  ...
  Widget _buildQcPendingStatusView(GrnModel grn) {
    ...
    final canUpdateGrn =
        splash?.hasPermission('GoodsReceivedNote', 'update') ?? false;
    isAllLineItemsChecked = grn.lineItems.every(
      (li) => _qcModifiedItems.containsKey(li.id),
    );
          ...
          children: grn.lineItems.map((li) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color: isModified ? AppColors.success : AppColors.cardBorder,
              ...
              child: Column(
                ...
                children: [
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    TrackingTypeBadge(
                                      trackingType: activeItem.trackingType,
                                    ),
                                  ],
                                ),
                              ],
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: _qcStatCol(
                          "Bad Qty (Rejected)",
                          "${activeItem.rejectedQuantity}",
                          activeItem.rejectedQuantity > 0
                              ? AppColors.error
                              : AppColors.textMuted,
                        ),
                      ),
                  ...
                  if (activeItem.rejectionReason != null &&
                      activeItem.rejectionReason!.isNotEmpty) ...[
                    ...
                    Container(
                      ...
                      child: Text(
                        "Rejection Reason: ${activeItem.rejectionReason}",
                        style: AppTextStyles.caption.copyWith(
                          color: AppColors.error,
                          fontWeight: FontWeight.w600,
                        ),
  ...
  void _handleQcItemSave(GrnLineItemModel updatedItem) {
    if (updatedItem.rejectedQuantity > 0 &&
        (updatedItem.rejectionReason == null ||
            updatedItem.rejectionReason!.trim().isEmpty)) {
      showDialog(
        context: context,
        barrierDismissible: false,
        builder: (ctx) => _RejectionReasonModal(
          onSave: (reason) {
            final itemWithReason = updatedItem.copyWith(
  ...
  Future<void> _confirmDeleteLineItem(GrnLineItemModel li) async {
    ...
    try {
      await ref
          .read(grnControllerProvider.notifier)
          .deleteGrnLineItem(widget.grn.id, widget.grn.purchaseOrderId, li.id);
      if (!mounted) return;
  ...
  Future<void> _submitQc() async {
    ...
    if (!isAllLineItemsChecked) {
      showTopErrorSnackBar(
        context,
        "Please complete quality check for all line item before submitting",
      );
      return;
    }
  ...
  Widget _buildCompletedStatusView(GrnModel grn) {
    return Column(
      ...
      children: [
        ...
        Text(
          "Inwarded Line Items (${grn.lineItems.length})",
          style: AppTextStyles.headingMedium,
        ),
        const SizedBox(height: 10),
        Column(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildMetadataRow(
            "Invoice Date",
            grn.vendorInvoiceDate != null
                ? HelperFunctions.formatDate(
                    DateTime.parse(grn.vendorInvoiceDate!),
                    hasTime: false,
                  )
                : "N/A",
          ),
          ...
          _buildMetadataRow(
            ...
            grn.receivedDate != null
                ? HelperFunctions.formatDate(
                    DateTime.parse(grn.receivedDate!),
                    hasTime: false,
                  )
                : "N/A",
          ),
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  if (!isAccepted &&
                      li.rejectionReason != null &&
                      li.rejectionReason!.isNotEmpty) ...[
                    Container(
                      width: double.infinity,
                      padding: const EdgeInsets.all(12),
                      decoration: BoxDecoration(
                  ...
                  if (li.trackingType == 'batch') ...[
                    Text(
                      "Batch Breakdown (${batches.length})",
                      style: AppTextStyles.labelMedium,
                    ),
                    const SizedBox(height: 8),
                    if (batches.isEmpty)
                      Text(
                        "No specific batches recorded.",
                        style: AppTextStyles.bodySmall.copyWith(
                          color: AppColors.textMuted,
                        ),
                      )
                    ...
                    if (serials.isEmpty)
                      Text(
                        "No specific serials recorded.",
                        style: AppTextStyles.bodySmall.copyWith(
                          color: AppColors.textMuted,
                        ),
                      )
                    else
                      ...serials.asMap().entries.map(
                        (e) => Container(
...
class _InwardedItemDetailsModal extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_InwardedItemDetailsModal> createState() =>
      _InwardedItemDetailsModalState();
}

class _InwardedItemDetailsModalState
    extends ConsumerState<_InwardedItemDetailsModal> {
  ...
  void initState() {
    ...
    _qtyController = TextEditingController(
      text: widget.item.receivedQuantity.toString(),
    );
  ...
  void _openBatchEditModal() {
    ...
    if (targetQty <= 0) {
      setState(
        () => _errorMessage =
            "Please enter a valid Received Quantity greater than 0 first.",
      );
      return;
    }
    showDialog(
  ...
  void _validateAndSave() {
    ...
    if (qty <= 0) {
      setState(
        () => _errorMessage = "Received Quantity must be greater than 0",
      );
      return;
    }

    final poSkuList =
        ref.read(poSkuItemsProvider(widget.grn.purchaseOrderId)).value ?? [];
    for (final p in poSkuList) {
      if (p.id == widget.item.productSkuId ||
          p.skuCode == widget.item.skuCode) {
        final maxAllowed = widget.item.receivedQuantity + p.remainingQuantity;
        if (qty > maxAllowed) {
          setState(
            () => _errorMessage =
                "Received Quantity ($qty) cannot exceed maximum allowed ($maxAllowed units, including current quantity + remaining PO units).",
          );
          return;
        }
        break;
    ...
    if (widget.item.trackingType == 'batch') {
      if (_batches.isEmpty) {
        setState(
          () => _errorMessage =
              "Please configure at least one batch for this item.",
        );
        return;
      }
      ...
      if (totalBatchQty != qty) {
        setState(
          () => _errorMessage =
              "Total batch quantity ($totalBatchQty) must equal Received Quantity ($qty). Please change batches.",
        );
        return;
      }
      ...
      if (_serials.length != qty) {
        setState(
          () => _errorMessage =
              "Number of serials (${_serials.length}) must equal Received Quantity ($qty). Please change serials.",
        );
        return;
      }
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text(
              "${widget.item.receivedQuantity} units",
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          if ((b.manufactureDate ?? b.manufacturedDate) !=
                                  null &&
                              (b.manufactureDate ?? b.manufacturedDate)!
                                  .isNotEmpty)
                            Text(
                              "Mfg: ${b.manufactureDate ?? b.manufacturedDate}",
                              style: AppTextStyles.caption.copyWith(
                                color: AppColors.textMuted,
                              ),
                            ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 8),
                Text(
                  "Untracked Item (Only quantity required)",
                  style: AppTextStyles.caption.copyWith(
                    color: AppColors.success,
                  ),
                ),
        ...
        if (widget.item.trackingType == 'batch') ...[
          Row(
            ...
            children: [
              Flexible(
                child: Text(
                  "Batches Configured (${_batches.length}):",
                  style: AppTextStyles.labelMedium.copyWith(
                    fontWeight: FontWeight.bold,
                  ),
                  overflow: TextOverflow.ellipsis,
              ...
              ElevatedButton.icon(
                ...
                label: Text(
                  _batches.isEmpty ? "Add Batches" : "Change Batches",
                ),
              ),
            ],
          ),
          ...
          if (_batches.isEmpty)
            Text(
              "No batches configured yet. Click above to add.",
              style: AppTextStyles.caption.copyWith(color: AppColors.textMuted),
            )
          else
            ListView.separated(
              ...
              itemBuilder: (ctx, i) {
                ...
                return Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Batch: ${b.batchCode}${b.expiryDate != null && b.expiryDate!.isNotEmpty ? ' (Exp: ${b.expiryDate})' : ''}",
                        style: AppTextStyles.caption.copyWith(
                          fontWeight: FontWeight.w600,
                        ),
                      ),
          ...
          Row(
            ...
            children: [
              Flexible(
                child: Text(
                  "Serials Entered (${_serials.length}):",
                  style: AppTextStyles.labelMedium.copyWith(
                    fontWeight: FontWeight.bold,
                  ),
                  overflow: TextOverflow.ellipsis,
              ...
              ElevatedButton.icon(
                ...
                label: Text(
                  _serials.isEmpty ? "Add Serials" : "Change Serials",
                ),
              ),
            ],
          ),
          ...
          if (_serials.isEmpty)
            Text(
              "No serial numbers configured yet. Click above to add.",
              style: AppTextStyles.caption.copyWith(color: AppColors.textMuted),
            )
          else
            Container(
          ...
          Text(
            "Untracked item: only received quantity is needed above.",
            style: AppTextStyles.caption.copyWith(color: AppColors.textMuted),
          ),
        ],
      ],
                        ...
                        onPressed: () {
                          ...
                          if (widget.initialEditing) {
                            ...
                            setState(() {
                              _isEditing = false;
                              _errorMessage = null;
                              _qtyController.text = widget.item.receivedQuantity
                                  .toString();
                              _batches = List.from(widget.item.receivedBatches);
                              _serials = List.from(widget.item.receivedSerials);
                            });
...
class _BatchInputModalState extends State<_BatchInputModal> {
  ...
  Future<void> _selectDate(BuildContext context, int index, bool isMfg) async {
    ...
    final mfgDate = batch.manufactureDate?.isNotEmpty == true
        ? DateTime.parse(batch.manufactureDate!)
        : DateTime.now();

    final picked = await showDatePicker(
      context: context,
      initialDate: initialDate,
      firstDate: isMfg ? DateTime(2020) : mfgDate,
      lastDate: isMfg ? DateTime.now() : DateTime(2035),
    );
  ...
  Widget build(BuildContext context) {
    ...
    final isValid =
        currentSum == widget.targetQty &&
        _batches.every((b) => b.batchCode.trim().isNotEmpty);
    ...
    return AlertDialog(
      title: Row(
        children: [
          Expanded(
            child: Text(
              "Add Batches (Target Qty: ${widget.targetQty})",
              style: AppTextStyles.headingMedium,
            ),
          ),
          const SizedBox(width: 8),
      ...
      content: SizedBox(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                "Total entered: $currentSum / ${widget.targetQty}",
                style: AppTextStyles.labelMedium.copyWith(
                        ...
                        children: [
                          Expanded(
                            child: TextFormField(
                              ...
                              onChanged: (val) => _batches[idx] = _batches[idx]
                                  .copyWith(batchCode: val),
                            ),
                          ),
                          IconButton(
                            padding: EdgeInsets.zero,
...
class _SerialInputModalState extends ConsumerState<_SerialInputModal> {
  ...
  Future<void> _addManualSerial() async {
    ...
    final isValid = await ref
        .read(grnControllerProvider.notifier)
        .validateSerial(s, widget.productSkuId);
    ...
    if (!isValid) {
      setState(
        () => _warningMsg =
            "Serial '$s' already exists in inventory or is invalid!",
      );
      return;
    }
    setState(() {
  ...
  Future<void> _handleBarcodeDetect(BarcodeCapture capture) async {
    ...
    for (final barcode in barcodes) {
      ...
      // Ignore duplicate detections within 2 seconds
      final now = DateTime.now();
      if (_lastScannedValue == s &&
          _lastScanTime != null &&
      ...
      if (_serials.contains(s)) {
        showTopErrorSnackBar(
          context,
          "Serial '$s' already exists in this list!",
        );
        return;
      }
    ...
    return AlertDialog(
      title: Row(
        children: [
          Expanded(
            child: Text(
              "Add Serials (Target: ${widget.targetQty})",
              style: AppTextStyles.headingMedium,
            ),
          ),
          const SizedBox(width: 8),
      ...
      content: SizedBox(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                "Total entered: ${_serials.length} / ${widget.targetQty} (Click any chip below to edit & resubmit)",
                style: AppTextStyles.labelMedium.copyWith(
                  color: isValid ? AppColors.success : AppColors.error,
                ),
              ),
              ...
              if (_selectedTab == 0) ...[
                ...
                const SizedBox(height: 8),
                ElevatedButton(
                  onPressed: _processBulkSerials,
                  child: const Text("Process Bulk Serials"),
                ),
              ] else ...[
                Center(
                  child: Column(
                    children: [
                      ...
                      Text(
                        _isValidating
                            ? "Please wait while we verify the serial."
              ...
              const SizedBox(height: 16),
              Text(
                "Added Serials (Click chip to edit):",
                style: AppTextStyles.labelMedium,
              ),
              const SizedBox(height: 8),
              Wrap(
...
class _QcBatchModalState extends State<_QcBatchModal> {
  ...
  void initState() {
    ...
    _goodControllers = widget.item.receivedBatches.map((b) {
      final accMatches =
          widget.item.acceptedBatches
              ?.where((a) => a.batchCode == b.batchCode)
              .toList() ??
          [];
      final rejMatches =
          widget.item.rejectedBatches
              ?.where((r) => r.batchCode == b.batchCode)
              .toList() ??
          [];
      if (accMatches.isNotEmpty || rejMatches.isNotEmpty) {
        return TextEditingController(
          text: (accMatches.isNotEmpty ? accMatches.first.quantity : 0)
              .toString(),
        );
      }
      return TextEditingController(text: b.quantity.toString());
    }).toList();

    _badControllers = widget.item.receivedBatches.map((b) {
      final accMatches =
          widget.item.acceptedBatches
              ?.where((a) => a.batchCode == b.batchCode)
              .toList() ??
      ...
      if (accMatches.isNotEmpty || rejMatches.isNotEmpty) {
        return TextEditingController(
          text: (rejMatches.isNotEmpty ? rejMatches.first.quantity : 0)
              .toString(),
        );
      }
  ...
  Widget build(BuildContext context) {
    ...
    int currentBad = 0;
    for (final c in _badControllers) {
      currentBad += int.tryParse(c.text) ?? 0;
    }
    bool reasonValid = true;
    if (currentBad > 0) {
      reasonValid = _reasonController.text.trim().isNotEmpty;
    }

    final isAllValid =
        reasonValid &&
        batches.asMap().entries.every((e) {
          final idx = e.key;
          final b = e.value;
    ...
    return AlertDialog(
      title: Row(
        children: [
          Expanded(
            child: Text(
              "QC Check: Confirm Batches (${widget.item.skuName})",
              style: AppTextStyles.headingMedium,
            ),
          ),
          const SizedBox(width: 8),
      ...
      content: SizedBox(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                "Enter Good Qty or Bad Qty for each batch. Total (Good + Bad) must equal Received Qty.",
                style: AppTextStyles.caption.copyWith(
                  color: AppColors.textMuted,
                ),
              ),
              ...
              ...batches.asMap().entries.map((entry) {
                ...
                final isValid =
                    (good + bad) == b.quantity && good >= 0 && bad >= 0;
...
class _QcSerialModalState extends State<_QcSerialModal> {
  ...
  Widget build(BuildContext context) {
    ...
    final isReasonValid =
        totBad == 0 || _reasonController.text.trim().isNotEmpty;
    ...
    return AlertDialog(
      title: Row(
        children: [
          Expanded(
            child: Text(
              "QC Check: Confirm Serial (${widget.item.skuName})",
              style: AppTextStyles.headingMedium,
            ),
          ),
          const SizedBox(width: 8),
            ...
            children: [
              ...
              ...serials.map((s) {
                ...
                return CheckboxListTile(
                  ...
                  subtitle: Text(
                    isGood ? "Status: Good Qty" : "Status: Bad Qty (Rejected)",
                    style: AppTextStyles.caption.copyWith(
        ...
        ElevatedButton(
          ...
          onPressed: isReasonValid
              ? () {
                  ...
                  final rejList = serials
                      .where((s) => !_acceptedSerials.contains(s))
                      .toList();
...
class _QcUntrackedModalState extends State<_QcUntrackedModal> {
  ...
  void initState() {
    super.initState();
    final hasBeenEdited =
        (widget.item.acceptedQuantity + widget.item.rejectedQuantity) > 0;
    final initialVal = hasBeenEdited
        ? widget.item.acceptedQuantity
        : widget.item.receivedQuantity;

    _acceptedController = TextEditingController(text: initialVal.toString());
    _reasonController = TextEditingController(
      text: widget.item.rejectionReason ?? "",
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final isReasonValid = rej == 0 || _reasonController.text.trim().isNotEmpty;
    final isAllValid = isValid && isReasonValid;
    ...
    return AlertDialog(
      title: Row(
        children: [
          Expanded(
            child: Text(
              "QC Check: Confirm Qty (${widget.item.skuName})",
              style: AppTextStyles.headingMedium,
            ),
          ),
          const SizedBox(width: 8),
      ...
      content: Column(
        ...
        children: [
          Text(
            "Enter Good Qty (Accepted) out of Received ($rec units).",
            style: AppTextStyles.caption.copyWith(color: AppColors.textMuted),
          ),
          const SizedBox(height: 16),
          TextFormField(
    ...
    return AlertDialog(
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          children: [
            Text(
              "You have recorded 1 or more units as Bad Qty (Rejected) for this product. Please enter the reason for rejection.",
              style: AppTextStyles.caption.copyWith(
                color: AppColors.textPrimary,
              ),
            ),
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: "Rejection Reason *",
                hintText:
                    "Enter exact issue (e.g. Damaged during transit, quality mismatch)",
              ),
              maxLines: 3,
              onChanged: (_) => setState(() {}),
            ),
